...
export default function AccountCart() {
    ...
    const totalAmountObject = useMemo(() => {
        return cartList.reduce(
            (acc, cur) => { //acc가 객체 (origin, discount 라는 필드가 존재)
                if (cur.choice === true) { //체크되어 있는 경우엔
                    return {
    ...
    return (<>
        ...
        {/* 
        <Row className= "mt-5 text-end fw-bold text-info fs-2">
        ...
        <Row className="mt-5">
            <Col>
                <div className="d-flex justify-content-between">
                    ...
                    <span>
                        {totalAmountObject.origin.toLocaleString()}원
                    </span>
                </div>
                <div className="d-flex justify-content-between">
                    <span>
                    ...
                    <span>
                        {(totalAmountObject.origin - totalAmountObject.discount).toLocaleString}원
                    </span>
                </div>
                <div className="d-flex justify-content-between">
                    <span>
                    ...
                    <span>
                        {totalAmountObject.discount.toLocaleString()}원
                    </span>
                </div>
            </Col>
        </Row>
