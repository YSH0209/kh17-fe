...
function Exam01() {
    ...
    // 통합 설정 함수
    // - React 에서는 함수를 만들 때 useCallback 훅을 사용
    ...
    return (
        <>
            ...
            <div className="row mt-4">
                <label claaName="col-sm-3 col-form-label">아이디</label>
            ...
            {/* 닉네임 입력화면 */}
            <div className="row mt-4">
                <label claaName="col-sm-3 col-form-label">닉네임</label>
                <div className="col-sm-9">
